...
// demo protocol version is not related to network protocol
...
#define PORT_MASTER 					27900 // 4.2.15
...
//void	  *VM_ArgPtr( intptr_t intValue ); //r00t:moved to vm_local.h so it can be inlined
...
#define VMF(x)	(*(float*)(&args[x])) //@r00t
