...
#define ALTERNATE_CURL_LIB "libcurl-4.dll"
...
extern CURL* (*qcurl_global_init)(long flags);
extern CURL* (*qcurl_global_cleanup)(void);
...
//extern CURLMcode (*qcurl_multi_setopt)(CURLM *multi_handle,
                                       //CURLMoption option, ...);
...
extern void (*qcurl_formfree)(struct curl_httppost *form);
extern CURLFORMcode (*qcurl_formadd)(struct curl_httppost **httppost,struct curl_httppost **last_post,...);
...
#define qcurl_global_cleanup curl_global_init
...
//#define qcurl_multi_setopt curl_multi_setopt
